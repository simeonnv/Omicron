...
pub fn subicron() -> Scope<impl ServiceFactory<ServiceRequest, Config = (), Response = ServiceResponse, Error = Error, InitError = ()>> {
    web::scope("/subicron")
        ...
        .service(posts::post_subicron_id_posts_id_upvote::post_subicron_id_posts_id_upvote)
        ...
        .service(comments::get_subicron_id_posts_id_comments::get_subicron_id_posts_id_comments)
        .service(comments::post_subicron_id_posts_id_comments::post_subicron_id_posts_id_comments)
}
